...
git clone --depth=1 https://github.com/psionicprjkt/android_prebuilts_clang_host_linux-x86_clang-r522817 prebuilts/clang/host/linux-x86/clang-r522817 && cd prebuilts/clang/host/linux-x86/clang-r522817 && git lfs fetch && git lfs install && git lfs checkout && cd ../../../../..
